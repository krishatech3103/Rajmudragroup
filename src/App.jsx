  ...
  return (
    <div className="app-container" onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd} onTouchCancel={handleTouchCancel}>
      ...
      <main className="content-wrapper">
        ...
        {activeTab === 'dashboard' && <Dashboard isAdmin={isAdmin} activeYear={activeYear} data={data} settings={settings} onUpdate={handleDataChange} onNavigateTab={handleTabChange} />}
        ...
        {activeTab === 'settings' && (isAdmin
          ...
          : <Dashboard isAdmin={isAdmin} activeYear={activeYear} data={data} settings={settings} onUpdate={handleDataChange} onNavigateTab={handleTabChange} />)}
      </main>
